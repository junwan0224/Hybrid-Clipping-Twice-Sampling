...
parser.add_argument('--lr', default= 2, type=float, help='base learning rate (default=0.1)')
...
parser.add_argument('--clip', default=[2.5, 1.3, 1, 0.7, 1], type=list, help='clipping threshold for gradient embedding')
parser.add_argument('--ratio', default=[1, 1, 1, 1, 1], type=list, help='infinite clipping ratio threshold for gradient embedding')
parser.add_argument('--clip_p', default=[2, 2, 2, 2, 2], type=list, help='clipping p for gradient embedding')
parser.add_argument('--power_iter', default=2, type=int, help='number of power iterations')
...
parser.add_argument('--cor_sample_rate', default=0.5, type=float, help='sampling probability for coordinate sampling')
parser.add_argument('--multi_aug', default= True, action='store_true', help='repeatly augment a sample multiple times')
parser.add_argument('--multi_times', default= 3, type=int, help='how many times we augment each sample')
parser.add_argument('--segment_bs', default= 1000, type=int, help='what is the batchsize for each segment')
...
noise_multiplier = [5.25, 7.25, 7.25, 7, 2.5]
